...
void SceneManager::LoadSceneTextures() {
	...
	bReturn = CreateGLTexture(
		"../../Projects/7-1_FinalProjectMilestones/textures/woodtexture.jpg",
		"table");
	bReturn = CreateGLTexture(
		"../../Projects/7-1_FinalProjectMilestones/textures/bowlBase.jpg",
		"bowlbase");
	bReturn = CreateGLTexture(
		"../../Projects/7-1_FinalProjectMilestones/textures/teal.jpg",
		"bowllip");
	bReturn = CreateGLTexture(
		"../../Projects/7-1_FinalProjectMilestones/textures/teal.jpg",
		"bowl");
	bReturn = CreateGLTexture(
		"../../Projects/7-1_FinalProjectMilestones/textures/breadcrust.jpg",
		"breadcrust");
	bReturn = CreateGLTexture(
		"../../Projects/7-1_FinalProjectMilestones/textures/eggshell.jpg",
		"egg");
